...
test('Load another page using saved token', async ({ request }) => {
  ...
  try {
    const response = await request.get('http://202.88.237.201:9988/matter/matter-history?matterId=2&limit=10&page=1&search=Rem&fromDate=2025-03-13&toDate=2025-03-15&dateTime=true&userId=2&actionType=CREATE', {
      headers,
    });
    if (response.ok()) {
